...
namespace CompressionStocking.BusinessLogic
{
    public class StockingCtrl : IButtonHandler, ICompressionEventListener
    {
        ...
        private readonly Factory.ICompressionFactory _fact;
        private readonly ICompressionMechanism _compressionMechanism;
        private readonly IUserOutput _userOutput;
        private State _state;

        public StockingCtrl(Factory.ICompressionFactory fact, Factory.Ioutputfactory userOutputfact)
        {
            _compressionMechanism = fact.CreateCompressionctrl();
            _userOutput = userOutputfact.CreateOutput();
