...
namespace HeapManagement
{
    public class Heap
    {
        ...
        private IFindebufferStrat _strat;

        public Heap(int size, IFindebufferStrat strat)
        {
            _strat = strat;
        ...
        public int Allocate(int size)
        {
            ...
            var startAddr = _strat.FindBuffer(size, FindCandidateBlocks(size)); // Delegated to concrete implementations
